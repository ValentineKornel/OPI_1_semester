...
void getUtf8RussianChar()
{
	setlocale(LC_CTYPE, "Russian");
	int dec_russian_char;
	wchar_t russian_char[] = L"Д";
	cout << "Д  -Russian char" << endl;
